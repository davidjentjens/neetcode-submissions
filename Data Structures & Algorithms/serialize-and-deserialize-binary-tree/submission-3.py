...
class Codec:
    ...
    def deserialize(self, data: str) -> Optional[TreeNode]:
        ...
        left_node_str = sub_nodes_str[:mid_pos_val]
        right_node_str = sub_nodes_str[mid_pos_val+1:]

        left_node = self.deserialize(left_node_str)
        right_node = self.deserialize(right_node_str)
